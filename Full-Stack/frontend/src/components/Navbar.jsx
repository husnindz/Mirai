  ...
  return (
    <header
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 ${
        scrolled ? 'bg-brand-primary/90 backdrop-blur-md shadow-lg py-3' : 'bg-transparent py-5'
      }`}
    >
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        >
          ...
          />
          <span className="font-montserrat font-bold text-2xl tracking-wide text-white">Mirai</span>
        </Link>
        ...
        <nav className="hidden lg:flex items-center gap-8">
          <Link
            to="/"
            onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
            className="font-montserrat font-semibold text-white/90 hover:text-brand-accent transition-colors duration-200"
          >
            {t.home}
          </Link>
          <a
      ...
      >
        ...
        <nav className="flex flex-col items-center gap-6">
          <Link
            ...
            to="/"
            className="font-montserrat font-bold text-2xl text-white hover:text-brand-accent transition-colors"
          >
            {t.home}
          </Link>
          <a
