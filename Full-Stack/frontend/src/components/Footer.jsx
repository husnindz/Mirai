...
export default function Footer() {
  ...
  return (
    <footer
      id="contact"
      className="bg-brand-primary text-white pt-20 pb-10 border-t border-white/10 relative overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 pb-16 border-b border-white/10">
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4 mt-2">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-brand-accent hover:text-brand-primary transition-all duration-300"
              >
          ...
          <div className="flex flex-col gap-6">
            ...
            <nav className="flex flex-col gap-3 font-sans text-sm text-white/80">
              ...
              <a href="#testimoni" className="hover:text-brand-accent transition-colors">
                {t.testimoni}
              </a>
