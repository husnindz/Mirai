...
export default function Dashboard({ username = 'Jati Sri Pamungkas', email = 'jatispamungkas357@gmail.com' }) {
  ...
  const getTranslatedParamName = (name) => {
    if (name === 'FBS (Gula Darah Puasa)') return language === 'id' ? 'FBS (Gula Darah Puasa)' : 'FBS (Fasting Blood Sugar)';
    if (name === 'RBS (Gula Darah Sewaktu)') return language === 'id' ? 'RBS (Gula Darah Sewaktu)' : 'RBS (Random Blood Sugar)';
  ...
  const [historyList, setHistoryList] = useState([
    { 
      ...
      parameters: {
        cholesterol: { value: '150', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '0 - 200' },
        creatinine: { value: '0.9', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '0.6 - 1.1' },
        fbs: { value: '90', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '70 - 100' },
        rbs: { value: '115', status: 'Tinggi', color: 'bg-[#EB5050] text-[#890909]', unit: 'mg/dL', range: '70 - 110' },
        hgb: { value: '14', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'g/dL', range: '12 - 16' },
        lymphocyte: { value: '35.8', status: 'Tinggi', color: 'bg-[#EB5050] text-[#890909]', unit: '%', range: '20 - 35' },
        mch: { value: '26.1', status: 'Rendah', color: 'bg-[#F2C039] text-[#836512]', unit: 'pg', range: '27 - 34' },
        mchc: { value: '34', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'g/dL', range: '32 - 36' },
        mcv: { value: '79.5', status: 'Rendah', color: 'bg-[#F2C039] text-[#836512]', unit: 'fL', range: '80 - 100' },
        ureum: { value: '28', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '17 - 43' },
        wbc: { value: '9', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: '10³/µL', range: '4 - 11' }
      },
      abnormalText: 'RBS (Gula Darah Sewaktu) (tinggi), Lymfosit (tinggi), MCH (rendah), MCV (rendah)',
    ...
    { 
      ...
      score: 67, 
      parameters: {
        cholesterol: { value: '165', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '0 - 200' },
        creatinine: { value: '0.8', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '0.6 - 1.1' },
        fbs: { value: '92', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '70 - 100' },
        rbs: { value: '105', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '70 - 110' },
        hgb: { value: '13', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'g/dL', range: '12 - 16' },
        lymphocyte: { value: '36.5', status: 'Tinggi', color: 'bg-[#EB5050] text-[#890909]', unit: '%', range: '20 - 35' },
        mch: { value: '28.5', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'pg', range: '27 - 34' },
        mchc: { value: '33', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'g/dL', range: '32 - 36' },
        mcv: { value: '82', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'fL', range: '80 - 100' },
        ureum: { value: '30', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '17 - 43' },
        wbc: { value: '8.5', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: '10³/µL', range: '4 - 11' }
      },
      abnormalText: 'Lymfosit (tinggi)',
      scores: { penyakitDalam: 0.67, paruParu: 0.45, jantung: 0.35 }
    },
    { id: 3, category: 'Penyakit Dalam', date: '16 Mei 2026, 13.21', risk: 'Sedang', riskColor: 'bg-[#F2C039] text-[#836512]', score: 67 },
    { id: 4, category: 'Penyakit Dalam', date: '16 Mei 2026, 13.21', risk: 'Sedang', riskColor: 'bg-[#F2C039] text-[#836512]', score: 67 },
    { id: 5, category: 'Penyakit Dalam', date: '16 Mei 2026, 13.21', risk: 'Sedang', riskColor: 'bg-[#F2C039] text-[#836512]', score: 67 },
    { id: 6, category: 'Penyakit Dalam', date: '16 Mei 2026, 13.21', risk: 'Sedang', riskColor: 'bg-[#F2C039] text-[#836512]', score: 67 },
    { id: 7, category: 'Penyakit Dalam', date: '16 Mei 2026, 13.21', risk: 'Sedang', riskColor: 'bg-[#F2C039] text-[#836512]', score: 67 },
    { id: 8, category: 'Penyakit Dalam', date: '16 Mei 2026, 13.21', risk: 'Sedang', riskColor: 'bg-[#F2C039] text-[#836512]', score: 67 },
    { id: 9, category: 'Penyakit Dalam', date: '16 Mei 2026, 13.21', risk: 'Sedang', riskColor: 'bg-[#F2C039] text-[#836512]', score: 67 },
    { id: 10, category: 'Penyakit Dalam', date: '16 Mei 2026, 13.21', risk: 'Sedang', riskColor: 'bg-[#F2C039] text-[#836512]', score: 67 },
    { id: 11, category: 'Jantung', date: '15 Mei 2026, 10.45', risk: 'Rendah', riskColor: 'bg-[#17ADB4] text-[#084F63]', score: 23 },
    { id: 12, category: 'Paru-paru', date: '14 Mei 2026, 16.30', risk: 'Rendah', riskColor: 'bg-[#17ADB4] text-[#084F63]', score: 18 }
  ]);
  ...
  const handleOpenCheckUp = () => {
    if (window.location.hash !== '#check-up' && window.location.hash !== '') {
      ...
      if (['dashboard', 'history', 'about'].includes(currentPath)) {
        const formattedMenu = currentPath === 'dashboard' ? 'Dashboard' :
                              currentPath === 'history' ? 'History' : 'About';
  ...
  const handleDrillDownResult = (item) => {
    ...
    if (!item.parameters) {
      ...
      item.parameters = {
        cholesterol: { value: isHigh ? '245' : '172', status: isHigh ? 'Tinggi' : 'Normal', color: isHigh ? 'bg-[#EB5050] text-[#890909]' : 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '0 - 200' },
        creatinine: { value: '0.8', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '0.6 - 1.1' },
        fbs: { value: isHigh ? '130' : '88', status: isHigh ? 'Tinggi' : 'Normal', color: isHigh ? 'bg-[#EB5050] text-[#890909]' : 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '70 - 100' },
        rbs: { value: '95', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '70 - 110' },
        hgb: { value: '14', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'g/dL', range: '12 - 16' },
        lymphocyte: { value: '28', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: '%', range: '20 - 35' },
        mch: { value: '29', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'pg', range: '27 - 34' },
        mchc: { value: '34', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'g/dL', range: '32 - 36' },
        mcv: { value: '88', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'fL', range: '80 - 100' },
        ureum: { value: '25', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: 'mg/dL', range: '17 - 43' },
        wbc: { value: '7', status: 'Normal', color: 'bg-[#17ADB4] text-[#084F63]', unit: '10³/µL', range: '4 - 11' }
      };
      item.abnormalText = isHigh ? 'Cholesterol Total (tinggi), FBS (tinggi)' : 'Semua parameter dalam rentang normal';
      item.scores = { 
        penyakitDalam: isHigh ? 0.81 : 0.20, 
        paruParu: isHigh ? 0.40 : 0.15, 
  ...
  const handleFinishCheckUp = () => {
    ...
    const paramResults = {
      cholesterol: { value: String(cholVal), ...checkStatus(cholVal, 0, 200), unit: 'mg/dL', range: '0 - 200' },
      creatinine: { value: String(creatinineVal), ...checkStatus(creatinineVal, 0.6, 1.1), unit: 'mg/dL', range: '0.6 - 1.1' },
      fbs: { value: String(fbsVal), ...checkStatus(fbsVal, 70, 100), unit: 'mg/dL', range: '70 - 100' },
      rbs: { value: String(rbsVal), ...checkStatus(rbsVal, 70, 110), unit: 'mg/dL', range: '70 - 110' },
      hgb: { value: String(hgbVal), ...checkStatus(hgbVal, 12, 16), unit: 'g/dL', range: '12 - 16' },
      lymphocyte: { value: String(lymphocyteVal), ...checkStatus(lymphocyteVal, 20, 35), unit: '%', range: '20 - 35' },
      mch: { value: String(mchVal), ...checkStatus(mchVal, 27, 34), unit: 'pg', range: '27 - 34' },
      mchc: { value: String(mchcVal), ...checkStatus(mchcVal, 32, 36), unit: 'g/dL', range: '32 - 36' },
      mcv: { value: String(mcvVal), ...checkStatus(mcvVal, 80, 100), unit: 'fL', range: '80 - 100' },
      ureum: { value: String(ureumVal), ...checkStatus(ureumVal, 17, 43), unit: 'mg/dL', range: '17 - 43' },
      wbc: { value: String(wbcVal), ...checkStatus(wbcVal, 4, 11), unit: '10³/µL', range: '4 - 11' }
    };
    ...
    Object.entries(paramResults).forEach(([key, param]) => {
      if (param.status !== 'Normal') {
        const displayName = key === 'cholesterol' ? 'Cholesterol Total' :
    ...
    const newRecord = {
      ...
      scores: {
        ...
        paruParu: category === 'Paru-paru' ? score / 100 : 0.20,
        jantung: category === 'Jantung' ? score / 100 : 0.40
      }
    };
    ...
    <div className="min-h-screen lg:h-screen w-full bg-[#EDFBFF] font-sans text-slate-800 flex flex-col lg:flex-row select-none relative lg:overflow-hidden">
      ...
      <header className="lg:hidden flex items-center justify-between px-6 py-4 bg-[#D9F6FF] border-b border-brand-primary/10 w-full z-40">
        ...
        <div className="flex items-center gap-3 relative">
          ...
          >
            <img src={userAvatar} alt="User Avatar" className="w-8 h-8 rounded-full border border-brand-primary/20" />
            <span className="font-semibold text-xs text-brand-primary truncate max-w-[80px]">{username}</span>
          </button>
        ...
        <div className="lg:hidden fixed inset-0 z-40 flex">
          ...
          <div className="relative flex flex-col w-[280px] max-w-xs h-full bg-[#D9F6FF] shadow-2xl p-6 animate-fade-in">
            ...
            <nav className="flex-1 py-6 space-y-3">
              ...
              >
                <svg className={`w-[20px] h-[20px] shrink-0 ${activeMenu === 'Dashboard' ? 'text-brand-accent' : 'text-[#262626]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <svg className={`w-[20px] h-[20px] shrink-0 ${activeMenu === 'Check-Up' ? 'text-brand-accent' : 'text-[#262626]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <svg className={`w-[20px] h-[20px] shrink-0 ${activeMenu === 'History' ? 'text-brand-accent' : 'text-[#262626]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <svg className={`w-[20px] h-[20px] shrink-0 ${activeMenu === 'About' ? 'text-brand-accent' : 'text-[#262626]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="px-4 py-2 border-t border-brand-primary/10 mt-2 select-none">
                <div className="flex items-center justify-between">
                  <span className="font-montserrat font-semibold text-[15px] text-[#262626]">{t.languageToggleLabel || 'Language'}</span>
      ...
      <aside className="hidden lg:flex flex-col w-[341px] lg:h-screen p-6 bg-transparent shrink-0 animate-fade-in">
        ...
        <div className="flex justify-center mb-8 mt-4 shrink-0">
          ...
          >
            <img style={{width: '100%', height: '100%', objectFit: 'contain'}} src={logoFull} alt="Mirai Logo" />
          </div>
        </div>
        ...
        <div className="flex flex-col h-full bg-[#D9F6FF] rounded-[20px] shadow-xl shadow-brand-primary/5 relative overflow-hidden flex-1">
          ...
          <nav className="flex-1 px-6 py-6 space-y-4">
            ...
            >
              <svg className={`w-[24px] h-[24px] shrink-0 ${activeMenu === 'Dashboard' ? 'text-brand-accent' : 'text-[#262626]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
              </svg>
            ...
            >
              <svg className={`w-[24px] h-[24px] shrink-0 ${activeMenu === 'Check-Up' ? 'text-brand-accent' : 'text-[#262626]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
              </svg>
            ...
            >
              <svg className={`w-[24px] h-[24px] shrink-0 ${activeMenu === 'History' ? 'text-brand-accent' : 'text-[#262626]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
              <span className={`font-montserrat font-semibold text-[26px] ${activeMenu === 'History' ? 'text-brand-accent' : ''}`}>{t.menuHistory}</span>
            </button>
            ...
            >
              <svg className={`w-[24px] h-[24px] shrink-0 ${activeMenu === 'About' ? 'text-brand-accent' : 'text-[#262626]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
          ...
          <div className="w-full h-[86px] px-5 bg-brand-primary flex items-center justify-between border-t border-white/10 shrink-0">
            ...
            <div className="relative">
              ...
              >
                <svg className={`w-5 h-5 transition-transform duration-300 ${showProfileMenu ? 'rotate-180' : ''}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {showProfileMenu && (
                <div className="absolute right-0 bottom-12 bg-white border border-brand-primary/10 rounded-lg shadow-xl py-1.5 w-44 z-50 animate-fade-in text-left">
                  ...
                  <div className="px-4 py-2 border-b border-slate-100 flex flex-col gap-1.5">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">{t.languageToggleLabel || 'Language'}</span>
        ...
        {activeMenu === 'History' && selectedHistoryItem ? (
          ...
          <div className="w-full text-left animate-fade-in select-none">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10 w-full">
              <div className="text-left">
                ...
                <nav className="flex items-center gap-2 mt-4 text-brand-primary font-montserrat font-semibold text-sm">
                  ...
                  <a href="#history" className="hover:underline" onClick={(e) => { e.preventDefault(); setSelectedHistoryItem(null); }}>{t.menuHistory}</a>
                  <span><ChevronRight /></span>
              ...
              <div className="flex flex-col items-end gap-2 self-center">
                ...
                <button
                  onClick={() => alert(language === 'id' ? 'Laporan PDF berhasil diekspor!' : 'PDF report exported successfully!')}
                  ...
                  <div className="space-y-1 text-left">
                    <span className="text-[#777777] text-[16px] font-poppins font-normal flex items-center gap-2">
                      ...
                      <span className="w-5 h-5 bg-brand-primary rounded-[5px] flex items-center justify-center shrink-0">
                        <svg className="w-3.5 h-3.5 text-[#77F9D0]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="space-y-[15px] flex-1 flex flex-col justify-center">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="w-full h-[12px] bg-[#96D8C3] rounded-[30px] relative overflow-hidden">
                      <div className="h-full bg-brand-primary rounded-[30px] transition-all" style={{ width: `${selectedHistoryItem.scores.penyakitDalam * 100}%` }} />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="w-full h-[12px] bg-[#96D8C3] rounded-[30px] relative overflow-hidden">
                      <div className="h-full bg-brand-primary rounded-[30px] transition-all" style={{ width: `${selectedHistoryItem.scores.paruParu * 100}%` }} />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="w-full h-[12px] bg-[#96D8C3] rounded-[30px] relative overflow-hidden">
                      <div className="h-full bg-brand-primary rounded-[30px] transition-all" style={{ width: `${selectedHistoryItem.scores.jantung * 100}%` }} />
                    </div>
                  </div>
                </div>
                  ...
                  <table className="w-full text-center border-collapse">
                    ...
                    <thead>
                      <tr className="bg-[#D9F6FF] h-[61px] border-b border-[#AFAFAF]">
                        <th className="w-[35%] text-[#262626] sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-2 sm:py-3 sm:px-8 text-left">Parameter</th>
                        <th className="w-[20%] text-[#262626] sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-2 sm:py-3 sm:px-8 text-right">{language === 'id' ? 'Nilai' : 'Value'}</th>
                        <th className="w-[25%] text-[#262626] sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-2 sm:py-3 sm:px-8">{language === 'id' ? 'Rentang' : 'Range'}</th>
                        <th className="w-[20%] text-[#262626] sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-2 sm:py-3 sm:px-8 text-center">{language === 'id' ? 'Status' : 'Status'}</th>
                      </tr>
                    </thead>

                    <tbody>
                      {Object.entries(selectedHistoryItem.parameters).map(([key, param]) => {
                        const displayName = key === 'cholesterol' ? (language === 'id' ? 'Kolesterol Total' : 'Total Cholesterol') :
                                            key === 'creatinine' ? (language === 'id' ? 'Kreatinin' : 'Creatinine') :
                                            key === 'fbs' ? (language === 'id' ? 'FBS (Gula Darah Puasa)' : 'FBS (Fasting Blood Sugar)') :
                                            key === 'rbs' ? (language === 'id' ? 'RBS (Gula Darah Sewaktu)' : 'RBS (Random Blood Sugar)') :
                                            key === 'hgb' ? (language === 'id' ? 'Hgb (Hemoglobin)' : 'Hgb (Hemoglobin)') :
                                            key === 'lymphocyte' ? (language === 'id' ? 'Lymfosit %' : 'Lymphocytes %') :
                                            key === 'mch' ? 'MCH' :
                                            key === 'mchc' ? 'MCHC' :
                                            key === 'mcv' ? 'MCV' :
                                            key === 'ureum' ? (language === 'id' ? 'Ureum' : 'Urea') :
                                            key === 'wbc' ? 'WBC' : key.toUpperCase();
                        ...
                        return (
                          ...
                          >
                            <td className="text-[#262626] sm:text-[14px] text-[11px] font-poppins font-medium py-1.5 px-2 sm:py-2.5 sm:px-8 text-left">{displayName}</td>
                            <td className="text-[#262626] sm:text-[14px] text-[11px] font-arimo font-bold py-1.5 px-2 sm:py-2.5 sm:px-8 text-right">
                              {param.value} <span className="text-[#777777] font-poppins font-normal text-[10px]">{param.unit}</span>
                            </td>
                            <td className="text-[#262626] sm:text-[14px] text-[11px] font-arimo font-bold py-1.5 px-2 sm:py-2.5 sm:px-8">{param.range}</td>
                            <td className="py-1.5 px-2 sm:py-2.5 sm:px-8 text-center">
                              <div className={`sm:w-[125px] w-[80px] sm:h-[30px] h-[22px] rounded-full flex items-center justify-center font-poppins font-semibold sm:text-[14px] text-[10px] mx-auto shadow-sm ${
                                param.status === 'Tinggi' || param.status === 'High' ? 'bg-[#EB5050] text-[#890909]' : 
                                param.status === 'Rendah' || param.status === 'Low' ? 'bg-[#F2C039] text-[#836512]' : 'bg-[#17ADB4] text-[#084F63]'
                              }`}>
            ...
            <div className="w-full bg-brand-primary p-8 rounded-[20px] text-left text-white shadow-xl shadow-brand-primary/10 select-none">
              <div className="flex items-center gap-4 mb-4">
                <h3 className="font-montserrat font-bold text-[32px] text-[#77F9D0]">
                  Disclaimer
                </h3>
                <div className="w-[38px] h-[38px] bg-[#F2C039] rounded-[5px] flex items-center justify-center shrink-0">
                  <svg className="w-6 h-6 text-[#836512]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
          ...
          <div className="w-full text-left">
            <div className="mb-10">
              ...
              <p className="font-poppins font-normal text-[20px] text-[#262626]">
                {language === 'id' ? 'Pantau semua riwayat pemeriksaan Anda di sini.' : 'Track all of your check-ups here.'}
              </p>
                ...
                <table className="w-full text-center border-collapse">
                  ...
                  <thead>
                    <tr className="bg-[#D9F6FF] h-[60px] border-b border-[#AFAFAF]">
                      <th className="w-[10%] text-brand-primary sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-1.5 sm:py-3 sm:px-4">{language === 'id' ? 'No' : 'No'}</th>
                      <th className="w-[28%] text-brand-primary sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-1.5 sm:py-3 sm:px-4">{language === 'id' ? 'Tanggal' : 'Date'}</th>
                      <th className="w-[24%] text-brand-primary sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-1.5 sm:py-3 sm:px-4">{language === 'id' ? 'Indikasi' : 'Indication'}</th>
                      <th className="w-[14%] text-brand-primary sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-1.5 sm:py-3 sm:px-4">{language === 'id' ? 'Probabilitas' : 'Probability'}</th>
                      <th className="w-[12%] text-brand-primary sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-1.5 sm:py-3 sm:px-4">{language === 'id' ? 'Risiko' : 'Risk'}</th>
                      <th className="w-[12%] text-brand-primary sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-1.5 sm:py-3 sm:px-4">{language === 'id' ? 'Aksi' : 'Action'}</th>
                    </tr>
                  </thead>
                  ...
                  <tbody>
                    {currentHistoryItems.map((item, index) => {
                      ...
                      return (
                        ...
                        >
                          <td className="text-[#262626] sm:text-[14px] text-[11px] font-poppins font-normal py-1.5 px-1.5 sm:py-2 sm:px-4">{rowNum}</td>
                          <td className="text-[#262626] sm:text-[14px] text-[11px] font-poppins font-normal py-1.5 px-1.5 sm:py-2 sm:px-4">{formatCheckUpDate(item.date)}</td>
                          
                          
                          <td className="py-1.5 px-1.5 sm:py-2 sm:px-4">
                            <span
                              className="text-[#262626] sm:text-[14px] text-[11px] font-arimo font-normal whitespace-nowrap"
                            >
                              {translateCategory(item.category)}
                            </span>
                          </td>

                          <td className="text-[#262626] sm:text-[14px] text-[11px] font-arimo font-normal py-1.5 px-1.5 sm:py-2 sm:px-4">{item.score}%</td>
                          <td className="text-[#262626] sm:text-[14px] text-[11px] font-poppins font-normal py-1.5 px-1.5 sm:py-2 sm:px-4">{translateRisk(item.risk)}</td>
                ...
                <div className="flex items-center gap-2 font-arimo">
                  {Array.from({ length: totalPages }).map((_, pageIdx) => {
                    ...
                    if (totalPages > 5 && pageNum > 2 && pageNum < totalPages - 1) {
                      if (pageNum === 3) {
                        return (
                          <span key="dots" className="w-[21px] text-center text-brand-primary text-[16px] font-normal leading-[17px]">
                            ...
                          </span>
                        );
                      }
          ...
          <div className="w-full text-left animate-fade-in select-none">
            <div className="mb-10">
              ...
              <p className="font-poppins font-normal text-[20px] text-[#262626]">
                {language === 'id' ? 'Informasi tentang bagaimana aplikasi kami bekerja.' : 'Information about how our application works.'}
              </p>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-[28px] w-full mb-12">
              ...
              <div className="bg-[#EDFBFF] border border-[#AFAFAF]/10 rounded-[20px] p-[20px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] flex gap-5 sm:h-[163px] min-h-[140px] h-auto pb-4 hover:translate-y-[-2px] transition-all duration-300">
                <div className="w-[100px] h-[100px] bg-[#146178] rounded-[5px] flex items-center justify-center shrink-0 shadow-inner">
                  <svg className="w-12 h-12 text-[#77F9D0]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="bg-[#EDFBFF] border border-[#AFAFAF]/10 rounded-[20px] p-[20px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] flex gap-5 sm:h-[163px] min-h-[140px] h-auto pb-4 hover:translate-y-[-2px] transition-all duration-300">
                <div className="w-[100px] h-[100px] bg-[#146178] rounded-[5px] flex items-center justify-center shrink-0 shadow-inner">
                  <svg className="w-12 h-12 text-[#77F9D0]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <div className="bg-[#EDFBFF] border border-[#AFAFAF]/10 rounded-[20px] p-[20px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] flex gap-5 sm:h-[163px] min-h-[140px] h-auto pb-4 hover:translate-y-[-2px] transition-all duration-300">
                <div className="w-[100px] h-[100px] bg-[#146178] rounded-[5px] flex items-center justify-center shrink-0 shadow-inner">
                  <svg className="w-12 h-12 text-[#77F9D0]" fill="none" viewBox="0 0 32 32" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="w-full bg-[#EDFBFF] border border-[#AFAFAF] rounded-[20px] shadow-[0px_4px_4px_rgba(0,0,0,0.25)] overflow-hidden">
                <div className="overflow-x-auto w-full">
                  <table className="w-full text-center border-collapse">
                    ...
                    <thead>
                      <tr className="bg-[#D9F6FF] h-[61px] border-b border-[#AFAFAF]">
                        <th className="w-[40%] text-[#262626] sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-2 sm:py-3 sm:px-8 text-left">{language === 'id' ? 'Parameter' : 'Parameter'}</th>
                        <th className="w-[35%] text-[#262626] sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-2 sm:py-3 sm:px-8">{t.normalRange || 'Rentang Normal'}</th>
                        <th className="w-[25%] text-[#262626] sm:text-[20px] text-[13px] font-montserrat font-semibold py-2 px-2 sm:py-3 sm:px-8 text-center">{t.unit || 'Satuan'}</th>
                      </tr>
                    </thead>
                    ...
                    <tbody>
                      {parametersReference.map((param, pIdx) => (
                        <tr 
                          ...
                          className="h-[40px] border-b border-[#AFAFAF]/20 hover:bg-white/30 transition-colors"
                        >
                          <td className="text-[#262626] sm:text-[14px] text-[11px] font-poppins font-medium py-1.5 px-2 sm:py-2.5 sm:px-8 text-left">{getTranslatedParamName(param.name)}</td>
                          <td className="text-[#262626] sm:text-[14px] text-[11px] font-arimo font-bold py-1.5 px-2 sm:py-2.5 sm:px-8">{param.range}</td>
                          <td className="text-[#262626] sm:text-[14px] text-[11px] font-poppins font-medium py-1.5 px-2 sm:py-2.5 sm:px-8 text-center">{param.unit}</td>
                        </tr>
                      ))}
                    </tbody>
              ...
              <div className="col-span-1 xl:col-span-8 bg-[#EDFBFF] border border-[#AFAFAF] rounded-[20px] p-6 shadow-sm flex flex-col justify-between">
                ...
                <div className="w-full flex-1 min-h-[200px] flex items-center justify-center relative select-none">
                  <svg viewBox="0 0 524 218" className="w-full h-auto">
                    ...
                    <text x="30" y="176" textAnchor="end" className="fill-[#A3A3A3] text-[10px] font-sans">0</text>
                    
                    <line x1="42" y1="129" x2="512" y2="129" stroke="#E2E8F0" strokeWidth="1" strokeDasharray="2 2" />
                    <text x="30" y="133" textAnchor="end" className="fill-[#A3A3A3] text-[10px] font-sans">25</text>
                    
                    <line x1="42" y1="86" x2="512" y2="86" stroke="#E2E8F0" strokeWidth="1" strokeDasharray="2 2" />
                    <text x="30" y="90" textAnchor="end" className="fill-[#A3A3A3] text-[10px] font-sans">50</text>
                    
                    <line x1="42" y1="43" x2="512" y2="43" stroke="#E2E8F0" strokeWidth="1" strokeDasharray="2 2" />
                    <text x="30" y="47" textAnchor="end" className="fill-[#A3A3A3] text-[10px] font-sans">75</text>
                    
                    <line x1="42" y1="10" x2="512" y2="10" stroke="#E2E8F0" strokeWidth="1" />
                    <text x="30" y="14" textAnchor="end" className="fill-[#A3A3A3] text-[10px] font-sans">100</text>

                    
                    <text x="42" y="197" textAnchor="middle" className="fill-[#A3A3A3] text-[10px] font-sans">Jan</text>
                    <text x="160" y="197" textAnchor="middle" className="fill-[#A3A3A3] text-[10px] font-sans">Feb</text>
                    <text x="278" y="197" textAnchor="middle" className="fill-[#A3A3A3] text-[10px] font-sans">Mar</text>
                    <text x="396" y="197" textAnchor="middle" className="fill-[#A3A3A3] text-[10px] font-sans">Apr</text>
                    <text x="512" y="197" textAnchor="middle" className="fill-[#A3A3A3] text-[10px] font-sans">{language === 'id' ? 'Mei' : 'May'}</text>

                    
                    <path d="M 42.5 172 L 42.5 148.76 C 82.5 148.76, 120.5 43.84, 160.5 43.84 C 200.5 43.84, 238.5 119.52, 278.5 119.52 C 318.5 119.52, 356.5 12.88, 396.5 12.88 C 436.5 12.88, 472.5 83.4, 512.5 83.4 L 512.5 172 Z" fill="url(#dalamGrad)" />
                    
                    <path d="M 42.5 172 L 42.5 54.16 C 82.5 54.16, 120.5 124.68, 160.5 124.68 C 200.5 124.68, 238.5 78.24, 278.5 78.24 C 318.5 78.24, 356.5 14.6, 396.5 14.6 C 436.5 14.6, 472.5 93.72, 512.5 93.72 L 512.5 172 Z" fill="url(#jantungGrad)" />
                    
                    <path d="M 42.5 172 L 42.5 78.24 C 82.5 78.24, 120.5 31.8, 160.5 31.8 C 200.5 31.8, 238.5 140.16, 278.5 140.16 C 318.5 140.16, 356.5 55.88, 396.5 55.88 C 436.5 55.88, 472.5 74.8, 512.5 74.8 L 512.5 172 Z" fill="url(#paruGrad)" />

                    
                    
                    <path d="M 42.5 148.76 C 82.5 148.76, 120.5 43.84, 160.5 43.84 C 200.5 43.84, 238.5 119.52, 278.5 119.52 C 318.5 119.52, 356.5 12.88, 396.5 12.88 C 436.5 12.88, 472.5 83.4, 512.5 83.4" fill="none" stroke="#146178" strokeWidth="2.5" />
                    <circle cx="42.5" cy="148.76" r="4.5" fill="#146178" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="160.5" cy="43.84" r="4.5" fill="#146178" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="278.5" cy="119.52" r="4.5" fill="#146178" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="396.5" cy="12.88" r="4.5" fill="#146178" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="512.5" cy="83.4" r="4.5" fill="#146178" stroke="#F8FDFF" strokeWidth="1.5" />

                    
                    <path d="M 42.5 54.16 C 82.5 54.16, 120.5 124.68, 160.5 124.68 C 200.5 124.68, 238.5 78.24, 278.5 78.24 C 318.5 78.24, 356.5 14.6, 396.5 14.6 C 436.5 14.6, 472.5 93.72, 512.5 93.72" fill="none" stroke="#1F78B4" strokeWidth="2.5" />
                    <circle cx="42.5" cy="54.16" r="4.5" fill="#1F78B4" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="160.5" cy="124.68" r="4.5" fill="#1F78B4" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="278.5" cy="78.24" r="4.5" fill="#1F78B4" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="396.5" cy="14.6" r="4.5" fill="#1F78B4" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="512.5" cy="93.72" r="4.5" fill="#1F78B4" stroke="#F8FDFF" strokeWidth="1.5" />

                    
                    <path d="M 42.5 78.24 C 82.5 78.24, 120.5 31.8, 160.5 31.8 C 200.5 31.8, 238.5 140.16, 278.5 140.16 C 318.5 140.16, 356.5 55.88, 396.5 55.88 C 436.5 55.88, 472.5 74.8, 512.5 74.8" fill="none" stroke="#17ADB4" strokeWidth="2.5" />
                    <circle cx="42.5" cy="78.24" r="4.5" fill="#17ADB4" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="160.5" cy="31.8" r="4.5" fill="#17ADB4" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="278.5" cy="140.16" r="4.5" fill="#17ADB4" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="396.5" cy="55.88" r="4.5" fill="#17ADB4" stroke="#F8FDFF" strokeWidth="1.5" />
                    <circle cx="512.5" cy="74.8" r="4.5" fill="#17ADB4" stroke="#F8FDFF" strokeWidth="1.5" />
                  </svg>
                </div>
              ...
              <div className="col-span-1 xl:col-span-4 bg-[#EDFBFF] border border-[#AFAFAF] rounded-[20px] p-6 shadow-sm flex flex-col">
                ...
                <div className="space-y-4 overflow-y-auto flex-1 pr-1 max-h-[350px]">
                  {historyList.slice(0, 8).map((item) => (
                    <div key={item.id} className="bg-[#D9F6FF] rounded-xl p-4 flex justify-between items-start hover:scale-[1.01] transition-transform duration-200">
                      <div className="space-y-1 text-left">
                        <button 
                          onClick={() => handleDrillDownResult(item)}
                        ...
                        <div className={`inline-block px-3 py-0.5 mt-2 rounded-full text-[11px] font-poppins font-medium ${item.riskColor}`}>
                          {translateRisk(item.risk)}
                        </div>
                      </div>
                      <div className="font-arimo font-bold text-[24px] text-brand-primary">
                        {item.score}<span className="font-poppins font-semibold">%</span>
                      </div>
                    </div>
                  ))}
                ...
                <div className="bg-[#EDFBFF] border border-[#AFAFAF] rounded-[20px] p-6 shadow-md shadow-brand-primary/5 flex flex-col justify-between h-[320px] hover:translate-y-[-4px] transition-transform duration-300 w-full">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="w-[30px] h-[30px] bg-[#EB5050] rounded-md flex items-center justify-center text-white font-bold">
                      <svg className="w-5 h-5 text-[#890909]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="bg-[#EDFBFF] border border-[#AFAFAF] rounded-[20px] p-6 shadow-md shadow-brand-primary/5 flex flex-col justify-between h-[320px] hover:translate-y-[-4px] transition-transform duration-300 w-full">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="w-[30px] h-[30px] bg-[#F2C039] rounded-md flex items-center justify-center text-white font-bold">
                      <svg className="w-5 h-5 text-[#836512]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {isCheckUpOpen && (
        <div className="fixed inset-0 z-50 bg-[#F8FDFF]/76 backdrop-blur-[8px] flex items-center justify-center animate-fade-in p-4 overflow-y-auto">
          ...
          <div className={`w-full max-w-[507px] bg-[#F8FDFF] border border-[#AFAFAF] rounded-[20px] p-8 relative shadow-2xl transition-all duration-300 ${
