    ...
    <section id="testimoni" className="py-24 bg-[#F8FDFF] relative overflow-hidden select-none">
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 z-10 relative">
        ...
        <div className="relative max-w-4xl mx-auto mb-20 text-center">
          ...
          <div 
            className="hidden lg:flex absolute left-[-170px] bottom-[-20px] w-[170px] h-[85px] p-4 bg-[#ECFAFE] shadow-[0px_5.01px_12.53px_rgba(0,0,0,0.15)] rounded-[5.01px] border border-[#757575]/10 -rotate-[4deg] transform-gpu flex-col justify-center items-center text-center cursor-default z-20 transition-all duration-300 ease-out hover:scale-110 hover:-translate-y-2.5 hover:shadow-[0px_10px_25px_rgba(0,0,0,0.22)]"
          >
            <span 
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-20 lg:hidden">
          ...
          <div className="bg-[#EDFBFF] p-6 rounded-[5.22px] border border-[#757575]/10 shadow-[0px_5.22px_13.06px_rgba(0,0,0,0.15)] flex flex-col justify-center items-center text-center">
            <span className="font-jakarta font-bold text-[25.83px] text-black leading-none mb-1">1000+</span>
            <span className="font-jakarta text-[10.45px] text-black font-normal leading-none">{t.statsScreening}</span>
          </div>
          ...
          <div className="bg-[#ECFAFE] p-6 rounded-[5.01px] border border-[#757575]/10 shadow-[0px_5.01px_12.53px_rgba(0,0,0,0.15)] flex flex-col justify-center items-center text-center">
            <span className="font-jakarta font-bold text-[24.78px] text-black leading-none mb-1">4.8/5</span>
            <span className="font-jakarta text-[10.02px] text-black font-normal leading-none">{t.statsSatisfaction}</span>
          </div>
          
          <div className="bg-[#EDFBFF] p-6 rounded-[5.22px] border border-[#757575]/10 shadow-[0px_5.22px_13.06px_rgba(0,0,0,0.15)] flex flex-col justify-center items-center text-center">
            <span className="font-jakarta font-bold text-[25.83px] text-black leading-none mb-1">50+</span>
            <span className="font-jakarta text-[10.45px] text-black font-normal leading-none">{t.statsReferralsShort}</span>
          </div>
          ...
          <div className="bg-[#EDFBFF] p-6 rounded-[5.01px] border border-[#757575]/10 shadow-[0px_5.01px_12.53px_rgba(0,0,0,0.15)] flex flex-col justify-center items-center text-center">
            <span className="font-jakarta font-bold text-[24.78px] text-black leading-none mb-1">100%</span>
            <span className="font-jakarta text-[10.02px] text-black font-normal leading-none">{t.statsEncryptionShort}</span>
          </div>
        </div>
            ...
            >
              ...
              <div className="flex justify-between items-start mb-3 border-b border-slate-200/10 pb-3">
                ...
                <div className="text-left leading-[20px] font-sans">
                  <h4 className={`text-[12px] font-bold ${test.isDark ? 'text-white' : 'text-black'}`}>
                    {test.name}
                  </h4>
                  <span className={`text-[12px] font-bold ${test.isDark ? 'text-white/80' : 'text-slate-700'}`}>
                    {test.role}
                  </span>
                </div>
              ...
              <p className={`font-sans text-[12px] font-medium leading-[20px] text-left flex-1 ${
